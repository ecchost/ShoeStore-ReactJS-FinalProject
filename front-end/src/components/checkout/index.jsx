...
class checkOut extends Component {
    ...
    handleSubmit(){
        if (this.validator.allValid()) {
            TransactionServices.create(this.state)
                .then(() => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/*SEO Support*/}
                <Helmet>
                    <title>MagicZola Checkout</title>
                                        ...
                                        <div className="col-lg-6 col-sm-12 col-xs-12">
                                            ...
                                            <div className="row check-out">
                                                ...
                                                <div className="form-group col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <select name="country" value={this.state.country || '' } ref="country"
                                                            onChange={this.setStateFromInput}>
                                                        <option>India</option>
                                                ...
                                                <div className="form-group col-md-12 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" name="pincode" value={this.state.pincode || '' }
                                                           ref="pincode" onChange={this.setStateFromInput}/>
                                                    ...
                                                    {(total !== 0) ?
                                                        <div className="text-right">
                                                            <button type="button" className="btn-solid btn"
                                                                    onClick={() => this.handleSubmit()}>Place
                                                                Order
                                                            </button>
                                                        </div>
                                                        : ''}
